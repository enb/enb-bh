...
module.exports = {
     ...
     * @returns {string}
     */
    buildModule: function (targetPath, bhEngine, inputSources, dependencies, jsAttrName, jsAttrScheme, jsCls,
                           useSourceMap, mimic) {
     ...
     * @returns {string}
     */
    build: function (targetPath, bhEngine, inputSources, dependencies, jsAttrName, jsAttrScheme, jsCls,
                     useSourceMap, mimic) {
        var file = new File(targetPath, useSourceMap);
