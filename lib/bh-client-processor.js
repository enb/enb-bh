...
module.exports = {
    ...
    buildModule: function (targetPath, bhEngine, inputSources, dependencies, jsAttrName, jsAttrScheme,
                           jsCls, useSourceMap, mimic) {
        var file = new File(targetPath, useSourceMap);

        this._defineModule('bh', file, dependencies, bhEngine, inputSources, jsAttrName, jsAttrScheme, jsCls, true);
     ...
     * @returns {string}
     */
    build: function (targetPath, bhEngine, inputSources, dependencies, jsAttrName, jsAttrScheme,
                     jsCls, useSourceMap, mimic) {
        var file = new File(targetPath, useSourceMap);
        return this._concatFile(file, bhEngine, inputSources, dependencies, jsAttrName, jsAttrScheme, jsCls, mimic);
    },
     ...
     */
    _concatFile: function (file, bhEngine, inputSources, dependencies, jsAttrName, jsAttrScheme, jsCls, mimic) {
        ...
        file.writeLine('    jsCls: ' + (jsCls ? ('\'' + jsCls + '\'') : false));
        file.writeLine('});');
    ...
    _defineModule: function (name, file, dependencies, bhEngine, inputSources, jsAttrName,
                                jsAttrScheme, jsCls, shouldConcatFile) {
        var libNames,
            depNames;
        ...
        if (shouldConcatFile) {
            this._concatFile(file, bhEngine, inputSources, dependencies, jsAttrName, jsAttrScheme, jsCls);
        }
