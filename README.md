...
**Совместимость:** пакет `enb-bh` поддерживает версию [шаблонизатора BH](https://ru.bem.info/technology/bh/) `4.1.0` и выше.
...
* [Использование]( #Использование)
    ...
    * [Шаблоны как этап сборки HTML](#Шаблоны-как-этап-сборки-html)
* [Принципы работы пакета](#Принципы-работы-пакета)
...
* [для сборки финального HTML](#Шаблоны-как-этап-сборки-html)

### Исполнение шаблонов в Node.js

В Node.js скомпилированный `?.bh.js`-файл подключается как модуль в формате [CommonJS](http://www.commonjs.org/).
...
>Принцип работы описан в разделе [Мимикрия под BEMHTML](#Мимикрия-под-bemhtml).
